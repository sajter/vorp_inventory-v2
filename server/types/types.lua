...
--- remove all standard items from the player's default inventory
---@param source integer player id
---@param callback fun(success:boolean)? async or sync callback
---@return boolean
function exports.vorp_inventory:subAllItems(source, callback) end

--- remove and delete all weapons
---@param source integer player id
---@param callback fun(success:boolean)? async or sync callback
---@return boolean
function exports.vorp_inventory:subAllWeapons(source, callback) end
...
--- set optional item durability (any number your schema uses, or nil to clear) by inventory item id; not for weapons
---@param source integer player id
---@param itemId number crafted item id (`items_crafted.id`)
---@param durability number|nil
---@param callback fun(success:boolean)? async or sync callback
function exports.vorp_inventory:setItemDurability(source, itemId, durability, callback) end
...
---@param source integer player id
---@param weaponId number weapon id
---@param component string|number component name or hash
---@param category string|number slot category
---@param callback fun(success:boolean)? async or sync callback
---@return boolean
function exports.vorp_inventory:addComponent(source, weaponId, component, category, callback) end
...
---@param callback fun(success:boolean)? async or sync callback
---@return boolean
function exports.vorp_inventory:subComponent(source, weaponId, component, category, callback) end
...
--- get custom inventory slot (capacity) limit
---@param invId string inventory id
---@param callback fun(slots:number|false)? async or sync callback; `false` if inventory is not registered
function exports.vorp_inventory:getCustomInventorySlots(invId, callback) end
...
---@param invId string inventory id
---@param data table fields to merge into stored custom-inventory data
---@param callback fun(success:boolean)? callback function async or sync leave nil
function exports.vorp_inventory:updateCustomInventoryData(invId, data, callback) end

--- see [documentation](https://docs.vorp-core.com/api-reference/inventory)<br>
--- open player inventory 
---@param data { title:string, target:integer, source:integer, blacklist:table?, itemsLimit:table?, timeout:number? }
---@param callback fun(success:boolean)? async or sync callback
function exports.vorp_inventory:openPlayerInventory(data, callback) end
